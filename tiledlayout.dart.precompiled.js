...
"^":"Tp:8;",
call$1:function(a){var z=J.x(a)
return typeof a==="object"&&a!==null&&!!z.$iscv}}}],["","file:///home/sander/work/dart/tiledlayout/web/tiledlayout.dart",,Y,{
"^":"",
Iq:[function(){Y.Bx(null)
var z=J.Vg(document.querySelector("#generate"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(Y.c0()),z.Sg),[H.Kp(z,0)]).Zz()},"call$0","eE",0,0,0],
Bx:[function(a){var z,y,x,w,v,u,t,s,r,q,p,o
z=new Y.yB([],0,0,C.CD.yu(C.jn.UD(6)),C.CD.yu(C.ON.UD(4.666666666666667)))
y=$.pa()
$.It()
x=y.j1(9)
w=document.querySelector("#tiles")
J.OG(w).V1(0)
for(v=0;v<30;++v){u=new Y.Zg(0,0,y.j1(2)+1,y.j1(2)+1)
if(z.mW(u)){t=x+1
s=document.createElement("div",null)
r=s.style
J.RE(r).sbM(r,"absolute")
C.rd.sn0(r,"0 10px 10px 0")
q=$.It()
p=C.jn.Y(x,9)
if(p<0||p>=9)return H.e(q,p)
C.rd.swX(r,q[p])
C.rd.sR(r,""+(u.R*150-10)+"px")
C.rd.sfg(r,""+(u.fg*150-10)+"px")
C.rd.sBb(r,""+(u.x*150+10)+"px")
C.rd.sG6(r,""+(u.y*150+10)+"px")
o=document.createElement("div",null)
J.pP(o).h(0,"num")
o.textContent=C.jn.bu(v)
s.appendChild(o)
w.appendChild(s)
x=t}}J.OE(w.style,H.d(z.Fy()*150)+"px")},"call$1","c0",2,0,5],
Zg:{
"^":"a;x,y>,R,fg>",
W5:function(a){var z,y
z=a.x
y=this.x
if(z<y+this.R&&z+a.R>y){z=a.y
y=this.y
z=z<y+this.fg&&z+a.fg>y}else z=!1
return z}},
yB:{
"^":"Zg;Ol,x,y,R,fg",
...
z=this.x
y=a.x
if(z<=y&&z+this.R>=y+a.R){z=this.y
y=a.y
z=z<=y&&z+this.fg>=y+a.fg}else z=!1
if(z)if(this.yM(a)){this.Ol.push(a)
return!0}return!1},
yM:function(a){for(;this.V6(a);)if(!this.Ty(a))return!1
return!0},
V6:function(a){var z
for(z=this.Ol,z=new H.a7(z,z.length,0,null);z.G();)if(z.lo.W5(a))return!0
return!1},
Ty:function(a){var z=a.x+1
a.x=z
if(z+a.R>this.x+this.R){a.x=0
z=a.y+1
a.y=z
if(z+a.fg>this.y+this.fg)return!1}return!0},
Fy:function(){var z,y,x,w,v
for(z=this.Ol,z=new H.a7(z,z.length,0,null),y=0;z.G();){x=z.lo
w=J.RE(x)
v=w.gy(x)
w=w.gfg(x)
if(typeof v!=="number")return v.g()
if(typeof w!=="number")return H.s(w)
y=P.y(y,v+w)}return y}}},1],])
...
I.$lazy($,"colors","MY","It",function(){return["orange","darkblue","red","green","blue","purple","yellow","turquoise","gray"]})
I.$lazy($,"random","Y4","pa",function(){return C.pr})

init.functionAliases={}
init.metadata=[{func:"X0",void:true},{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"bB",void:true,args:[W.Aj]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"uO",args:[J.O]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
Zf.prototype=$desc
function Zg(x,y,R,fg){this.x=x
this.y=y
this.R=R
this.fg=fg}Zg.builtin$cls="Zg"
if(!"name" in Zg)Zg.name="Zg"
$desc=$collectedClasses.Zg
if($desc instanceof Array)$desc=$desc[1]
Zg.prototype=$desc
Zg.prototype.gy=function(receiver){return this.y}
Zg.prototype.gfg=function(receiver){return this.fg}
function yB(Ol,x,y,R,fg){this.Ol=Ol
this.x=x
this.y=y
this.R=R
this.fg=fg}yB.builtin$cls="yB"
if(!"name" in yB)yB.name="yB"
$desc=$collectedClasses.yB
if($desc instanceof Array)$desc=$desc[1]
yB.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,ct,nB,i3,it,QP,IF,n6,Ny,nx,QQ,fW,y4,d7,Um,oJ,He,HA,vH,xO,Em,NW,rV,Wy,QF,hs,cm,Nh,cv,Fs,hY,ea,D0,as,Aa,u5,Yu,iG,jP,Ax,xf,xn,Vb,QH,ST,X2,tb,pA,Mi,HL,In,wP,eP,A6,Og,M6,El,mC,SV,aB,fJ,Ih,Vh,rC,ZY,cx,Ee,Qb,PG,F3,xI,Aj,oU,eY,KV,BH,KY,G7,l9,Ql,wL,bP,FH,SN,HD,ni,rR,qj,nC,KR,ew,fs,bX,lr,MC,iQ,j2,Ea,lp,kd,I0,yN,Cp,ua,HN,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,kJ,FB,xV,Pe,y6,RH,Kn,Z2,w6,BR,vw,aG,J6,Oi,UM,hq,WS,r0,yp,c1,Mq,Nf,Nc,Mx,rh,Zv,Q7,yK,Dh,ZJ,mU,eZ,IT,JY,Pq,kx,nV,ui,D6,DQ,Sm,xL,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,QN,N9,BA,d0,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,NJ,qI,jf,rQ,Lx,f6,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,YS,ox,ZD,vt,cu,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Xr,Sl,Qm,ET,V6,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,cC,RA,IY,JH,jl,Iy,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,ku,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,dC,wN,VX,a7,i1,xy,MH,U5,SO,SU,Ca,vs,da,xw,dm,rq,RW,YP,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,MO,nP,dR,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,ar,lD,ZQ,Sw,o0,CL,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,An,c8,a,mE,Rn,wv,BV,id,VG,zL,ec,e7,dx,kE,hm,x5,I4,Fk,RO,eu,xC,Pb,W9,O7,IU,mg,b0,Pg,Ob,GV,As,GE,D7,Zf,Zg,yB]}